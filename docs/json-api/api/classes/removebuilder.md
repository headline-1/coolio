...
*Defined in [jsonApi.remove.ts:6](https://github.com/headline-1/coolio/blob/420fd1d/packages/json-api/src/jsonApi.remove.ts#L6)*
...
*Defined in [jsonApi.remove.ts:12](https://github.com/headline-1/coolio/blob/420fd1d/packages/json-api/src/jsonApi.remove.ts#L12)*
